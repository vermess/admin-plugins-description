...
class Admin_Plugins_Description
{
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Admin_Plugins_Description_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct()
	{
		...
		$this->plugin_name = 'admin-plugins-description';
	 ...
	 *
	 * - Admin_Plugins_Description_Loader. Orchestrates the hooks of the plugin.
	 * - Admin_Plugins_Description_i18n. Defines internationalization functionality.
	 * - Admin_Plugins_Description_Admin. Defines all hooks for the admin area.
	 * - Admin_Plugins_Description_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Admin_Plugins_Description_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
